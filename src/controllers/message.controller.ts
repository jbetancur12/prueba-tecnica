...
export const getMessagesHandler = async (
    ...
    try {
        const messages = await findMessages({}, { id: true, title: true, content: true, "user": { id: true }, comments: { content: true }, reactions: { reaction: true }, createdAt: true }, { comments: true, user: true, reactions: true });
